defmodule KioskCommon.NervesHubManager do
  use GenServer
  ...
  defp get_prop_table do
    PropertyTable.get_all(KioskCommon.NervesHub) |> Map.new()
  end

  defp write_prop_table(new) do
    PropertyTable.put_many(KioskCommon.NervesHub, Enum.to_list(new))
    PropertyTable.flush_to_disk(KioskCommon.NervesHub)
  end
