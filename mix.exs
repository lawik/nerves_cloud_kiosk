defmodule Kiosk.MixProject do
  ...
  defp deps do
    [
      ...
      {:nerves_hub_link,
       github: "lawik/nerves_hub_link", branch: "extension-pubsub", override: true, runtime: false},
      {:nerves_hub_link_geo, github: "nervescloud/nerves_hub_link_geo", runtime: false},
      {:nerves_hub_health, github: "nervescloud/nerves_hub_health", runtime: false},
      {:nerves_hub_cli, "~> 2.0"},
      #{:frio_rpi4,
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind kiosk", "esbuild kiosk"],
      "assets.deploy": [
